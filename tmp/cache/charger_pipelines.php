...
include_once_check(_ROOT_PLUGINS.'auto/z/v1.7.21/z_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v1.27.0/saisies_pipelines.php');
$inc=true;
}
$val = minipipe('cvtmulti_styliser', $val);
$val = minipipe('vertebres_styliser', $val);
$val = minipipe('Z_styliser', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'compagnon/compagnon_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/medias_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/videos/v0.10.2/videos3_pipelines.php');
$inc=true;
}
$val = minipipe('compagnon_affiche_gauche', $val);
$val = minipipe('medias_affiche_gauche', $val);
$val = minipipe('videos_affiche_gauche', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'urls_etendues/urls_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/menus/inc/menus_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/formidable/v1.3.5/formidable_autorisations.php');
...
$val = minipipe('menus_autoriser', $val);
...
include_once_check(_ROOT_PLUGINS.'auto/menus/base/menus_tables.php');
include_once_check(_ROOT_PLUGINS.'auto/formidable/v1.3.5/base/formidable_tables.php');
include_once_check(_ROOT_PLUGINS.'auto/transaction/v0.3.1/base/transaction.php');
...
$val = minipipe('menus_declarer_tables_principales', $val);
...
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/z/v1.7.21/z_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/menus/menus_pipelines.php');
$inc=true;
}
$val = minipipe('Z_declarer_url_objets', $val);
$val = minipipe('menus_declarer_url_objets', $val);
return $val;
}
...
$val = minipipe('menus_header_prive', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'porte_plume/porte_plume_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/z/v1.7.21/z_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/squelette_maparaan/v1.0.0/squelette_maparaan_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/menuder/v2.1.4/menuder_fonctions.php');
include_once_check(_ROOT_PLUGINS.'auto/transaction/v0.3.1/transaction_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'compresseur/compresseur_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/videos/v0.10.2/videos3_pipelines.php');
$inc=true;
}
...
$val = minipipe('Z_insert_head', $val);
$val = minipipe('squelette_maparaan_insertion_in_head', $val);
$val = minipipe('menuder_insert_head', $val);
...
$val = minipipe('menuder_insert_head_css', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'petitions/petitions_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'sites/sites_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/formidable/v1.3.5/formidable_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/breves_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/base/medias.php');
$inc=true;
}
...
$val = minipipe('menus_pre_boucle', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'auto/facteur/v2.4.5/facteur_ieconfig_metas.php');
...
// Pipeline menus_lister_disponibles 
function execute_pipeline_menus_lister_disponibles(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/menus/menus_pipelines.php');
$inc=true;
}
$val = minipipe('menus_menus_lister_disponibles', $val);
return $val;
}
// Pipeline ieconfig 
function execute_pipeline_ieconfig(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/menus/menus_ieconfig.php');
$inc=true;
}
$val = minipipe('menus_ieconfig', $val);
return $val;
}
