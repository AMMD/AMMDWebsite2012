 ...
 * Compile :   Tue, 16 Apr 2013 09:53:06 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../prive/formulaires/inc-apercu-logo.html
// Temps de compilation total: 2.832 ms
//
...
'
	' .
vide($Pile['vars'][(string)'largeur'] = interdire_scripts(largeur(entites_html(table_valeur(@$Pile[0], (string)'logo', null),true)))) .
vide($Pile['vars'][(string)'hauteur'] = interdire_scripts(hauteur(entites_html(table_valeur(@$Pile[0], (string)'logo', null),true)))) .
