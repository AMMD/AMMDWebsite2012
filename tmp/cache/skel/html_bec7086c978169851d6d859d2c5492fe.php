...
// Temps de compilation total: 20.995 ms
//
...
' .
		bouton_action(_T('medias:lien_tout_enlever'),invalideur_session($Cache, generer_action_auteur('dissocier_document',(	invalideur_session($Cache, @$Pile[0]['id_objet']) .
				...
				'-I/image'),invalideur_session($Cache, ancre_url(self(),'illustrations')))),'ajax tout_supprimer') .
		'
</div>
' .
...
' .
		bouton_action(_T('medias:lien_tout_enlever'),invalideur_session($Cache, generer_action_auteur('dissocier_document',(	invalideur_session($Cache, @$Pile[0]['id_objet']) .
				'-' .
				interdire_scripts(invalideur_session($Cache, @$Pile[0]['objet'])) .
				'-I/document'),invalideur_session($Cache, ancre_url(self(),'portfolio')))),'ajax tout_supprimer') .
		'
</div>
' .
...
' .
		bouton_action(_T('medias:lien_tout_enlever'),invalideur_session($Cache, generer_action_auteur('dissocier_document',(	invalideur_session($Cache, @$Pile[0]['id_objet']) .
				'-' .
				interdire_scripts(invalideur_session($Cache, @$Pile[0]['objet'])) .
				'-D/document'),invalideur_session($Cache, ancre_url(self(),'documents')))),'ajax tout_supprimer') .
		'
</div>
' .
