...
/*
 * Squelette : squelettes/contenu/rubrique.html
 * Date :      Tue, 16 Apr 2013 12:27:06 GMT
 * Compile :   Wed, 01 May 2013 21:35:30 GMT
 * Boucles :   _ariane, _m2, _miniplan, _sous_rubriques, _articles, _contenu_rubrique
 */ 

function BOUCLE_arianehtml_ba1f8dab59240462414b85e0200ee558(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('rubriques.statut','!','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/contenu/rubrique.html','html_ba1f8dab59240462414b85e0200ee558','_ariane',4,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function BOUCLE_m2html_ba1f8dab59240462414b85e0200ee558(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {

	static $command = array();
	static $connect;
	$command['connect'] = $connect = '';
	$save_numrows = (isset($Numrows['_miniplan']) ? $Numrows['_miniplan'] : array());
	$t0 = (($t1 = BOUCLE_miniplanhtml_ba1f8dab59240462414b85e0200ee558($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('
				<ul class="menu-liste">
					' . $t1 . '
				</ul>
...
function BOUCLE_miniplanhtml_ba1f8dab59240462414b85e0200ee558(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('rubriques.statut','!','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/contenu/rubrique.html','html_ba1f8dab59240462414b85e0200ee558','_miniplan',39,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
...
'</a>
						' .
BOUCLE_m2html_ba1f8dab59240462414b85e0200ee558($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					</li>
					');
	}
...
function BOUCLE_sous_rubriqueshtml_ba1f8dab59240462414b85e0200ee558(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('rubriques.statut','!','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/contenu/rubrique.html','html_ba1f8dab59240462414b85e0200ee558','_sous_rubriques',30,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
...
'</a>
				...
				' .
(($t1 = BOUCLE_miniplanhtml_ba1f8dab59240462414b85e0200ee558($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('
				<ul class="menu-liste">
					' . $t1 . '
				</ul>
...
function BOUCLE_articleshtml_ba1f8dab59240462414b85e0200ee558(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('articles.statut','publie,prop,prepa','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/contenu/rubrique.html','html_ba1f8dab59240462414b85e0200ee558','_articles',17,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'
		' .
recuperer_fond( 'inclure/article-resume' , array('id_article' => $Pile[$SP]['id_article'] ), array('compil'=>array('squelettes/contenu/rubrique.html','html_ba1f8dab59240462414b85e0200ee558','_articles',22,$GLOBALS['spip_lang'])), ''));
	}
	lang_select();
	$iter->free();
	}
...
function BOUCLE_contenu_rubriquehtml_ba1f8dab59240462414b85e0200ee558(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('rubriques.statut','!','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/contenu/rubrique.html','html_ba1f8dab59240462414b85e0200ee558','_contenu_rubrique',1,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
...
'</a>' .
BOUCLE_arianehtml_ba1f8dab59240462414b85e0200ee558($Cache, $Pile, $doublons, $Numrows, $SP) .
...
' .
(($t1 = BOUCLE_articleshtml_ba1f8dab59240462414b85e0200ee558($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
')) :
	...
	' .
	(($t2 = BOUCLE_sous_rubriqueshtml_ba1f8dab59240462414b85e0200ee558($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
			((	'
...
' .
recuperer_fond( 'inclure/documents' , array('id_rubrique' => $Pile[$SP]['id_rubrique'] ), array('compil'=>array('squelettes/contenu/rubrique.html','html_ba1f8dab59240462414b85e0200ee558','_contenu_rubrique',60,$GLOBALS['spip_lang'])), '') .
'	
...
executer_balise_dynamique('FORMULAIRE_SITE',
	...
	array('squelettes/contenu/rubrique.html','html_ba1f8dab59240462414b85e0200ee558','_contenu_rubrique',64,$GLOBALS['spip_lang'])) .
'
...
//
// Fonction principale du squelette squelettes/contenu/rubrique.html
// Temps de compilation total: 11.830 ms
//

function html_ba1f8dab59240462414b85e0200ee558($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	...
	$connect = '';
	$page = (
BOUCLE_contenu_rubriquehtml_ba1f8dab59240462414b85e0200ee558($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_ba1f8dab59240462414b85e0200ee558', $Cache, $page, 'squelettes/contenu/rubrique.html');
}
?>