...
/*
 * Squelette : plugins/auto/saisies/v1.27.0/saisies/_base.html
 * Date :      Sun, 04 Mar 2012 20:00:10 GMT
 * Compile :   Wed, 01 May 2013 21:35:30 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette plugins/auto/saisies/v1.27.0/saisies/_base.html
// Temps de compilation total: 13.050 ms
//

function html_8f425206fba737b416b8e524b4d70da2($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
(($t1 = strval(interdire_scripts(((entites_html(table_valeur(@$Pile[0], (string)'nom', null),true)) ?' ' :''))))!=='' ?
	...
	'readonly' => table_valeur($Pile["vars"], (string)'readonly', null) )), array('compil'=>array('plugins/auto/saisies/v1.27.0/saisies/_base.html','html_8f425206fba737b416b8e524b4d70da2','',12,$GLOBALS['spip_lang'])), '') .
		'
	')) :
			'') .
	'
	...
	'disable' => table_valeur($Pile["vars"], (string)'disable', null) ,
	'readonly' => table_valeur($Pile["vars"], (string)'readonly', null) )), array('compil'=>array('plugins/auto/saisies/v1.27.0/saisies/_base.html','html_8f425206fba737b416b8e524b4d70da2','',0,$GLOBALS['spip_lang'])), '') .
		'
			' .
...
');
	...
	return analyse_resultat_skel('html_8f425206fba737b416b8e524b4d70da2', $Cache, $page, 'plugins/auto/saisies/v1.27.0/saisies/_base.html');
}
?>